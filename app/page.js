  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <section className="max-w-6xl mx-auto px-4 py-8">
        ...
        <p className="mt-2 mb-4">📞 7054062092</p>

        {/* ✅ ONLY WHATSAPP BUTTON — NO RAW URL */}
        <a
          href="https://wa.me/917054062092"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-block mb-6 bg-green-600 text-white px-6 py-3 rounded-lg font-semibold"
        >
